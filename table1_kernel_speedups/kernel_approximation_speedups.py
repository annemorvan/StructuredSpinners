...
#==============================================================================
    ...
    d_pr_list = [512, 1024, 2048, 4096, 8192, 16384, 32768]
...
# SPEED-UPS
#==============================================================================
    # TODO: use synthetic data by uncommenting the corresponding part
    #  
    # OMP_NUM_THREADS=1 python kernel_approximation_speedups.py
    ...
    for i in xrange(len(d_pr_list)):
        d = d_pr_list[i]
        d_pr = d_pr_list[i]
        print('d, d_pr', d, d_pr)        
        X = np.random.normal(0.0, 1.0, d*n).reshape(d,n)    
        X /= np.linalg.norm(X, axis = 0).reshape(-1,1).T

        t = test_gaussian_speedups(X, d, d_pr, n, sigma, blocks_list, bonus)
        t1.append(t)
    ...
    assert len(t1) == len(t2) == len(t3) == len(t4) == len(t5)
    print('')
    print('m', d_pr_list)    
    print('t1 G', t1)
    print('t2 HD3HD2HD1', t2)
    print('t3 GSKEWD2HD1', t3)
    print('t4 HGAUSSHD2HD1', t4)
    print('t5 GTOEPLITZD2HD1', t5)
    ...
    print('')
    print('m', d_pr_list)
    print('r2 HD3HD2HD1', r2)
    print('r3 GSKEWD2HD1', r3)
    print('r4 HGAUSSHD2HD1', r4)
    print('r5 GTOEPLITZD2HD1', r5)
    
    X = np.asarray([  d_pr_list, r5, r3, r4, r2]).T
    #print(X)    
    np.savetxt("gausiankernel_speedups.csv", X, delimiter=",") 
    print('Add the header m,TOEPLITZD2HD1,GSKEWD2HD1,HGAUSSHD2HD1,HD3HD2HD1 to the file gausiankernel_speedups.csv')   
